...
public class InstitutionDTO implements Serializable {
    ...
    static Logger logger = LoggerFactory.getLogger(InstitutionDTO.class);
	...
	public boolean equals(Object obj) {
		...
		if (raison_sociale == null) {
			if (other.raison_sociale != null)
				return false;
		} else if (!raison_sociale.equals(other.raison_sociale))
			return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((raison_sociale == null) ? 0 : raison_sociale.hashCode());
		return result;
	}
	...
	public String toString() {
		return "InstitutionDTO [dtype=" + dtype + ", ID_AUDITE=" + ID_AUDITE + ", isValid=" + isValid + ", nom_audite="
				+ nom_audite + ", latitude_boutique=" + latitude_boutique + ", longitude_boutique=" + longitude_boutique
				+ ", adresse_boutique=" + adresse_boutique + ", phone_boutique=" + phone_boutique + ", raison_sociale="
				+ raison_sociale + "]";
	}
